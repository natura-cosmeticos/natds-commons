module.exports = {
  ...
  collectCoverageFrom: [
    ...
    '!<rootDir>/packages/natds-icons/src/index.js',
    '!<rootDir>/packages/natds-icons/src/actions/buildPreviousIconCodes.js',
    '!<rootDir>/packages/natds-icons/src/actions/writeFiles.js',
    '!<rootDir>/packages/natds-icons/src/actions/buildInitialFontData/buildInitialFontData.js',
    '!<rootDir>/packages/natds-icons/src/actions/optimizeSvg/optimizeSvg.js',
