...
describe('icons library', () => {
  ...
  it('should create icon names json file', () => {
    const jsonFile = getStringFile('../src/natds-icons.json');
  ...
  it('should create json type definition file', () => {
    const jsonDefinitionFile = getStringFile('../src/natds-icons.json.d.ts');
  ...
  it('should create css file', () => {
    const cssFile = getStringFile('../src/natds-icons.css');
  ...
  it('should create css type definition file', () => {
    const cssDefinitionFile = getStringFile('../src/natds-icons.css.d.ts');
  ...
  it('should create swift icon name file', () => {
    const swiftFile = getStringFile('../src/natds-icons.swift');
