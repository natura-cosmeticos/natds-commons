...
struct BiomeLightTokens: Tokens {
  let assetFontFileDisplay = "Roboto-Regular"
  let assetFontFileHeadline = "Roboto-Regular"
  let assetFontFileBodyRegular = "Roboto-Regular"
  let assetFontFileBodyBold = "Roboto-Medium"
