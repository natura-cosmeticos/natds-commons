...
struct ConsultoriaDeBelezaDarkComponents: Components {
  ...
  let avatarColorBackground = "#FFFBB5"
  ...
  let badgeColorPrimaryBackground = "#FFFBB5"
  ...
  let buttonContainedColorEnableBackground = "#FFFBB5"
  ...
  let buttonOutlinedColorEnableBorder = "#FFFBB5"
  ...
  let progressIndicatorColorStroke = "#FFFBB5"
  ...
  let radioButtonColorSelectBorder = "#FFFBB5"
  let radioButtonColorSelectContent = "#FFFBB5"
  ...
  let shortcutContainedColorEnablePrimaryBackground = "#FFFBB5"
  ...
  let shortcutOutlinedColorEnablePrimaryBorder = "#FFFBB5"
  ...
  let tagColorBackgroundPrimary = "#FFFBB5"
