...
struct NaturaDarkComponents: Components {
  ...
  let navigationDrawerSectionTitleFontSize: CGFloat = 16
  let navigationDrawerSectionTitleLetterSpacing: CGFloat = 0.08
  let navigationDrawerSectionTitleLineHeight: CGFloat = 1.5
  let navigationDrawerSectionTitlePrimaryFontFamily = "San Francisco"
  let navigationDrawerSectionTitlePrimaryFontWeight: UIFont.Weight = .medium
  ...
  let navigationDrawerSectionItemFontSize: CGFloat = 16
  let navigationDrawerSectionItemLetterSpacing: CGFloat = 0.32
